...
const USER_AGENT = "fourtwentycoins-dist@0.0.0";
const TAG = "latest";
...
(async function() {
    ...
    let includeFourtwentycoins = false;
    ...
    for (let i = 0; i < dirnames.length; i++) {
        ...
        if (dirname === "fourtwentycoins") {
            includeFourtwentycoins = true;
        }
    ...
    if (includeFourtwentycoins) {
        ...
        // Upload the scripts to the CDN and refresh the edge caches
        {
            ...
            for (let i = 0; i < fileInfos.length; i++) {
                ...
                log(`<bold:Uploaded :> https://cdn.fourtwentycoins.io/lib/${ fileInfo.key }`);
            }
