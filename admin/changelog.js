...
async function generate() {
    ...
    let lastVersion = await npm.getPackageVersion("fourtwentycoins");
    ...
    // @TODO:
    // fourtwentycoins/version ([date](tag))
    let newSection = {
        title: `fourtwentycoins/v${ local.loadPackage("fourtwentycoins").version } (${utils.getDateTime(new Date())})`,
        underline: "-",
        body: [ ]
    }
...
function latestChange() {
    ...
    const match = recent.title.match(/fourtwentycoins\/([^\(]*)\(([^\)]*)\)/);
