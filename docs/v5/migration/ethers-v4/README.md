...
Migration: From Fourtwentycoin v4
=========================
...
```
// v4
fourtwentycoins.utils.BigNumber
fourtwentycoins.utils.BigNumberish

// v5
fourtwentycoins.BigNumber
fourtwentycoins.BigNumberish
```
...
```
// v4
new fourtwentycoins.utils.BigNumber(someValue)
fourtwentycoins.utils.bigNumberify(someValue);

// v5
// - Constructor is private
// - Removed `bigNumberify`
fourtwentycoins.BigNumber.from(someValue)
```
...
// v5
contract.estimateSmoke.transfer(toAddress, amount)
```
...
```
// v4
fourtwentycoins.errors.UNKNOWN_ERROR
fourtwentycoins.errors.*
...
fourtwentycoins.utils.Logger.errors.*
...
interface.functions.transfer.smoke
