...
#### *fourtwentycoins* . *BigNumber* . **from**( aBigNumberish ) => *[BigNumber](/v5/api/utils/bignumber/)*
...
#### *fourtwentycoins* . *BigNumnber* . **isBigNumber**( object ) => *boolean*
...
The functions [parseFourtwentycoin( fourtwentycoinString )](/v5/api/utils/display-logic/#utils-parseFourtwentycoin) and [formatFourtwentycoin( marley )](/v5/api/utils/display-logic/#utils-formatFourtwentycoin) can be used to convert between string representations, which are displayed to or entered by the user and Big Number representations which can have mathematical operations handled safely.
