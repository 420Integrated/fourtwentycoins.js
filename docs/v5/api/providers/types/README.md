...
#### *block* . **smokeLimit** => *[BigNumber](/v5/api/utils/bignumber/)*

The maximum amount of smoke that this block was permitted to use. This is a value that can be voted up or voted down by miners and is used to automatically adjust the bandwidth requirements of the network.

This property is generally of little interest developers.


#### *block* . **smokeUsed** => *[BigNumber](/v5/api/utils/bignumber/)*

The total amount of smoke used by all transactions in this block.
...
#### *transactionRequest* . **smokeLimit** => *[BigNumber](/v5/api/utils/bignumber/) | Promise< [BigNumber](/v5/api/utils/bignumber/) >*

The maximum amount of smoke this transaction is permitted to use.


#### *transactionRequest* . **smokePrice** => *[BigNumber](/v5/api/utils/bignumber/) | Promise< [BigNumber](/v5/api/utils/bignumber/) >*

The price (in marley) per unit of smoke this transaction will pay.
...
The amount (in marley) this transaction is sending.


#### *transactionRequest* . **chainId** => *number | Promise< number >*

The chain ID this transaction is authorized on, as specified by [EIP-155](x/EIPS/eip-155).
...
Only transactions included in blocks **before** the [Byzantium Hard Fork](x/EIPS/eip-609) have this property, as it was replaced by the `status` property.
...
#### *receipt* . **smokeUsed** => *[BigNumber](/v5/api/utils/bignumber/)*

The amount of smoke actually used by this transaction.
...
#### *receipt* . **cumulativeSmokeUsed** => *[BigNumber](/v5/api/utils/bignumber/)*

For the block this transaction was included in, this is the sum of the smoke used used by each transaction in the ordered list of transactions up to (and including) this transaction.
...
This is true if the block is in a [post-Byzantium Hard Fork](x/EIPS/eip-609) block.


#### *receipt* . **status** => *boolean*

The status of a transaction is 1 is successful or 0 if it was reverted. Only transactions included in blocks [post-Byzantium Hard Fork](x/EIPS/eip-609) have this property.
