...
provider.getBalance("ricmoo.firefly.fourtwenty");
// { Promise: { BigNumber: "1492974808274631213" } }

// Get the code for a contract...
provider.getCode("registrar.firefly.fourtwenty");
...
provider.getStorageAt("registrar.firefly.fourtwenty", 0)
// { Promise: '0x000000000000000000000000314159265dd8dbb310642f98f50c066173c1259b' }

// Get transaction count of an account...
provider.getTransactionCount("ricmoo.firefly.fourtwenty");
// { Promise: 679 }
```
...
//   smokeLimit: { BigNumber: "3141592" },
//   smokeUsed: { BigNumber: "21000" },
...
//       smokeLimit: { BigNumber: "90000" },
//       smokePrice: { BigNumber: "54588778004" },
...
dot420 Naming Service (ENS) Methods
-------------------------------------
...
// { Promise: 'registrar.firefly.fourtwenty' }

// Lookup an address of an ENS name...
provider.resolveName("ricmoo.firefly.fourtwenty");
...
#### *provider* . **getSmokePrice**( ) => *Promise< [BigNumber](/v5/api/utils/bignumber/) >*

Returns a *best guess* of the [Smoke Price](/v5/concepts/smoke/#smoke-price) to use in a transaction.
...
// Get the current suggested smoke price (in marley)...
smokePrice = await provider.getSmokePrice()
// { BigNumber: "69000000000" }

// ...often this smoke price is easier to understand or
// display to the user in gmarley (giga-marley, or 1e9 marley)
utils.formatUnits(smokePrice, "gmarley")
// '69.0'
```
...
Returns the result of executing the *transaction*, using *call*. A call does not require any 420coins, but cannot change any state. This is useful for calling gettings on Contracts.


#### *provider* . **estimateSmoke**( transaction ) => *Promise< [BigNumber](/v5/api/utils/bignumber/) >*

Returns an estimate of the amount of smoke that would be required to submit *transaction* to the network.
