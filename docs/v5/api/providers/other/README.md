...
#### **new ***fourtwentycoins* . *providers* . **FallbackProvider**( providers [ , quorum ] )
...
#### **new ***fourtwentycoins* . *providers* . **UrlJsonRpcProvider**( [ network [ , apiKey ] ] )
...
#### **new ***fourtwentycoins* . *providers* . **Web3Provider**( externalProvider [ , network ] )
...
This follows the [Web3.js Provider Signature](https://github.com/420integrated/go-420coin/web3.js/blob/1.x/packages/web3-providers-http/types/index.d.ts#L57).
...
#### **new ***fourtwentycoins* . *provider* . **WebSocketProvider**( [ url [ , network ] ] )
