...
var hdnode_1 = require("@420integrated/hdnode");
var keccak256_1 = require("@420integrated/keccak256");
var pbkdf2_1 = require("@420integrated/pbkdf2");
var random_1 = require("@420integrated/random");
var properties_1 = require("@420integrated/properties");
var transactions_1 = require("@420integrated/transactions");
...
function _getAccount(data, key) {
    ...
    if (utils_1.searchPath(data, "x-fourtwentycoins/version") === "0.1") {
        var mnemonicCiphertext = utils_1.looseArrayify(utils_1.searchPath(data, "x-fourtwentycoins/mnemonicCiphertext"));
        var mnemonicIv = utils_1.looseArrayify(utils_1.searchPath(data, "x-fourtwentycoins/mnemonicCounter"));
        var mnemonicCounter = new aes_js_1.default.Counter(mnemonicIv);
        var mnemonicAesCtr = new aes_js_1.default.ModeOfOperation.ctr(mnemonicKey, mnemonicCounter);
        var path = utils_1.searchPath(data, "x-fourtwentycoins/path") || hdnode_1.defaultPath;
        var locale = utils_1.searchPath(data, "x-fourtwentycoins/locale") || "en";
