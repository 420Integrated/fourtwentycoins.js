...
import { arrayify, Bytes, BytesLike, concat, hexlify } from "@420integrated/bytes";
import { defaultPath, entropyToMnemonic, HDNode, Mnemonic, mnemonicToEntropy } from "@420integrated/hdnode";
import { keccak256 } from "@420integrated/keccak256";
import { pbkdf2 as _pbkdf2 } from "@420integrated/pbkdf2";
import { randomBytes } from "@420integrated/random";
import { Description } from "@420integrated/properties";
import { computeAddress } from "@420integrated/transactions";
...
export function encrypt(account: ExternallyOwnedAccount, password: Bytes | string, options?: EncryptOptions, progressCallback?: ProgressCallback): Promise<string> {
    ...
    if (!client) { client = "fourtwentycoins.js"; }
