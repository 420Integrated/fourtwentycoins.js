...
and debug 420coin-related tasks using the fourtwentycoins.js library.

**To install:**

```
/home/ricmoo> npm install -g @420integrated/cli
```
...
to running `node`, with many features from the fourtwentycoins.js library
...
```
/home/ricmoo> fourtwentycoins init ropsten.json
...
Saved:               ropsten.json
/home/ricmoo> fourtwentycoins --wait --network ropsten fund 0xe923a7f82860C30442a1A541C14bE4251bd71A34
Transaction Hash: 0x457c1d8b58170c73a02afa2816e877de41d6337a483d4af9cbd674d2b478473d
/home/fourtwentycoins>
```

**Example:** Simple evaluations

```
/home/ricmoo> fourtwentycoins eval 'namehash("ricmoose.fourtwenty")'
0xb52c4744695ed3be701ccef35d5901de3aaf7294245966ef16617c30aab7b626

/home/ricmoo> fourtwentycoins eval 'id("Hello...")'
0x9cd41c139084dafa62261ce045f504e3c697fa303c87a78b241a9f8ae65bae88

/home/ricmoo> fourtwentycoins --network ropsten eval '(new Contract(provider.network.ensAddress, [ "function owner(bytes32) view returns (address)" ], provider)).owner(namehash("fourtwenty"))'
...
```
/home/ricmoo> fourtwentycoins --network ropsten --account mnemonic.txt
network: ropsten (chainId: 3)
ropsten> provider.getSmokePrice()
...
COMMANDS (default: sandbox)
   ...
   fund TARGET                Fund TARGET with testnet 420coins
   info [ TARGET ... ]        Dump info for accounts, addresses and ENS names
   send TARGET FOURTWENTYCOIN          Send FOURTWENTYCOIN 420coins to TARGET form accounts[0]
      [ --allow-zero ]           Allow sending to the address zero
      [ --data DATA ]            Include data in the transaction
   sweep TARGET               Send all 420coins from accounts[0] to TARGET
...
```
Usage:
   fourtwentycoins-ens COMMAND [ ARGS ] [ OPTIONS ]
...
COMMANDS
   ...
   set-subnode NAME           Set a subnode owner (default: current account)
      [ --address ADDRESS ]      Specify another address
   set-resolver NAME          Set the resolver (default: resolver.fourtwenty)
      [ --address ADDRESS ]      Specify another address
