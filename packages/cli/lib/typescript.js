...
exports.header = "import { fourtwentycoins } from \"fourtwentycoins \";\n\n";
function generate(contract, bytecode) {
    ...
    var _loop_1 = function (signature) {
        ...
        var output_1 = "Promise<fourtwentycoins.providers.TransactionResponse>";
        var overrides = "fourtwentycoins.CallOverrides";
    ...
    contract.interface.fragments.forEach(function (fragment) {
        lines.push("            \"" + fragment.format(fourtwentycoins_1.fourtwentycoins.utils.FormatTypes.full) + "\",");
    });
    lines.push("        ];");
    lines.push("    }");
    lines.push("}");
