...
var basex_1 = require("@420integrated/basex");
...
var fourtwentyLegacyRegistrarAbi = [
...
var EnsPlugin = /** @class */ (function (_super) {
    ...
    function EnsPlugin() {
        ...
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(_this, "_fourtwentyAddressCache", {});
        return _this;
    }
    EnsPlugin.prototype.getEns = function () {
        return new fourtwentycoins_1.fourtwentycoins.Contract(this.network.ensAddress, ensAbi, this.accounts[0] || this.provider);
    };
    EnsPlugin.prototype.getResolver = function (nodehash) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!!this._fourtwentyAddressCache[nodehash]) return [3 /*break*/, 2];
                        _a = this._fourtwentyAddressCache;
                        _b = nodehash;
                        return [4 /*yield*/, this.getEns().resolver(nodehash)];
                    case 1:
                        _a[_b] = _c.sent();
                        _c.label = 2;
                    case 2: return [2 /*return*/, new fourtwentycoins_1.fourtwentycoins.Contract(this._fourtwentyAddressCache[nodehash], resolverAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getFourtwentyInterfaceAddress = function (interfaceId) {
        return __awaiter(this, void 0, void 0, function () {
            var fourtwentyNodehash, resolver, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        fourtwentyNodehash = fourtwentycoins_1.fourtwentycoins.utils.namehash("fourtwenty");
                        if (!!this._fourtwentyAddressCache[interfaceId]) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.getResolver(fourtwentyNodehash)];
                    case 1:
                        resolver = _c.sent();
                        _a = this._fourtwentyAddressCache;
                        _b = interfaceId;
                        return [4 /*yield*/, resolver.interfaceImplementer(fourtwentyNodehash, interfaceId)];
                    case 2:
                        _a[_b] = _c.sent();
                        _c.label = 3;
                    case 3: return [2 /*return*/, this._fourtwentyAddressCache[interfaceId]];
                }
            });
        });
    };
    EnsPlugin.prototype.getFourtwentyController = function () {
        return __awaiter(this, void 0, void 0, function () {
            var address;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFourtwentyInterfaceAddress(InterfaceID_Controller)];
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new fourtwentycoins_1.fourtwentycoins.Contract(address, fourtwentyControllerAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getFourtwentyLegacyRegistrar = function () {
        return __awaiter(this, void 0, void 0, function () {
            var address;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getFourtwentyInterfaceAddress(InterfaceID_Legacy)];
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new fourtwentycoins_1.fourtwentycoins.Contract(address, fourtwentyLegacyRegistrarAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
    EnsPlugin.prototype.getFourtwentyRegistrar = function () {
        return __awaiter(this, void 0, void 0, function () {
            var address;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getEns().owner(fourtwentycoins_1.fourtwentycoins.utils.namehash("fourtwenty"))];
                    case 1:
                        address = _a.sent();
                        return [2 /*return*/, new fourtwentycoins_1.fourtwentycoins.Contract(address, fourtwentyRegistrarAbi, this.accounts[0] || this.provider)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        ens = this.getEns();
                        return [4 /*yield*/, this.getFourtwentyController()];
                    case 2:
                        controller = _a.sent();
                        return [4 /*yield*/, this.getFourtwentyRegistrar()];
                    case 3:
                        registrar = _a.sent();
                        return [4 /*yield*/, this.getFourtwentyLegacyRegistrar()];
                    case 4:
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        nodehash = fourtwentycoins_1.fourtwentycoins.utils.namehash(name_1);
                                        details = {
                                            Nodehash: nodehash
                                        };
                                    ...
                                    case 1:
                                        ...
                                        if (!(owner === fourtwentycoins_1.fourtwentycoins.constants.AddressZero)) return [3 /*break*/, 2];
                                        owner = null;
                                        return [3 /*break*/, 4];
                                    case 2:
                                        ...
                                        return [4 /*yield*/, ens.resolver(nodehash).then(function (address) {
                                                if (address === fourtwentycoins_1.fourtwentycoins.constants.AddressZero) {
                                    ...
                                    case 4:
                                        comps = name_1.split(".");
                                        if (!(comps.length === 2 && comps[1] === "fourtwenty")) return [3 /*break*/, 11];
                                        details.Labelhash = fourtwentycoins_1.fourtwentycoins.utils.id(comps[0].toLowerCase()); // @TODO: nameprep
                                        _b = details;
                                    ...
                                    case 7:
                                        ownerOf = _f.sent();
                                        if (ownerOf !== fourtwentycoins_1.fourtwentycoins.constants.AddressZero) {
                                    ...
                                    case 9:
                                        entry = _f.sent();
                                        deed = new fourtwentycoins_1.fourtwentycoins.Contract(entry.owner, deedAbi, this_1.provider);
                                        _c = details;
                                        return [4 /*yield*/, deed.owner()];
                                    case 10:
                                        _c.Registrant = _f.sent();
                                        details.Registrar = "Legacy";
                                        details["Deed Value"] = (fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(entry.value) + " 420coin");
                                        details["Highest Bid"] = (fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(entry.highestBid) + " 420coin");
                                        return [3 /*break*/, 11];
                                    case 11:
                                        if (!resolverAddress) return [3 /*break*/, 16];
                                        resolver = new fourtwentycoins_1.fourtwentycoins.Contract(resolverAddress, resolverAbi, this_1.provider);
                                        _d = details;
                                        _e = "Address";
                                    ...
                                    case 14:
                                        ...
                                        return [4 /*yield*/, resolver.contenthash(nodehash).then(function (hash) {
                                                ...
                                                if (hash.substring(0, 10) === "0xe3010170" && fourtwentycoins_1.fourtwentycoins.utils.isHexString(hash, 38)) {
                                                    return basex_1.Base58.encode(fourtwentycoins_1.fourtwentycoins.utils.hexDataSlice(hash, 4)) + " (IPFS)";
                                                }
...
var AccountPlugin = /** @class */ (function (_super) {
    ...
    AccountPlugin.getHelp = function () {
        return logger.throwError("subclasses must implement this", fourtwentycoins_1.fourtwentycoins.errors.UNSUPPORTED_OPERATION, {
            operation: "getHelp"
        });
    };
    AccountPlugin.prototype._setValue = function (key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, key, value);
                        if (!(key === "name")) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._setValue("nodehash", fourtwentycoins_1.fourtwentycoins.utils.namehash(value))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        helpLine = fourtwentycoins_1.fourtwentycoins.utils.getStatic(this.constructor, "getHelp")().name;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(key === "name")) return [3 /*break*/, 2];
                        comps = value.split(".");
                        if (comps.length !== 2 || comps[1] !== "fourtwenty") {
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (secret) {
                            ...
                            this.salt = fourtwentycoins_1.fourtwentycoins.utils.id(secret);
                        }
                    ...
                    case 5:
                        ...
                        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "duration", duration * (60 * 60 * 24));
                        return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        signature = _a.sent();
                        this.salt = fourtwentycoins_1.fourtwentycoins.utils.keccak256(signature);
                        _a.label = 3;
...
var CommitPlugin = /** @class */ (function (_super) {
    ...
    CommitPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fourtwentyController, commitment, fee;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.run.call(this)];
                    case 1:
                        ...
                        return [4 /*yield*/, this.getFourtwentyController()];
                    case 2:
                        fourtwentyController = _a.sent();
                        return [4 /*yield*/, fourtwentyController.makeCommitment(this.label, this.owner, this.salt)];
                    case 3:
                        commitment = _a.sent();
                        return [4 /*yield*/, fourtwentyController.rentPrice(this.label, this.duration)];
                    case 4:
                        fee = _a.sent();
                        this.dump("Commit: " + this.name, {
                            ...
                            Fee: fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(fee) + " (informational)",
                            Commitment: commitment
                        });
                        return [4 /*yield*/, fourtwentyController.commit(commitment)];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.dump("Reveal: " + this.name, {
                            ...
                            Fee: fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(fee),
                        });
                        return [4 /*yield*/, fourtwentyController.register(this.label, this.owner, this.duration, this.salt, {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getEns().setSubnodeOwner(fourtwentycoins_1.fourtwentycoins.utils.namehash(this.node), fourtwentycoins_1.fourtwentycoins.utils.id(this.label), this.address)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var SetResolverPlugin = /** @class */ (function (_super) {
    ...
    SetResolverPlugin.getHelp = function () {
        return {
            ...
            help: "Set the resolver (default: resolver.fourtwenty)"
        };
    };
    SetResolverPlugin.prototype.getDefaultAddress = function () {
        return this.getAddress("resolver.fourtwenty");
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        nodehash = fourtwentycoins_1.fourtwentycoins.utils.namehash(this.address.substring(2) + ".addr.reverse");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        multihash = fourtwentycoins_1.fourtwentycoins.utils.concat(["0xe3010170", bytes]);
                        return [4 /*yield*/, _super.prototype._setValue.call(this, "multihash", fourtwentycoins_1.fourtwentycoins.utils.hexlify(multihash))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, _super.prototype._setValue.call(this, key, value)];
...
var MigrateRegistrarPlugin = /** @class */ (function (_super) {
    ...
    MigrateRegistrarPlugin.prototype.prepareArgs = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var comps, fourtwentyLegacyRegistrar, entry, deed, owner, address;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.prepareArgs.call(this, args)];
                    case 1:
                        ...
                        if (comps.length !== 2 || comps[1] !== "fourtwenty") {
                            this.throwError("Not a top-level .fourtwenty name");
                        }
                        return [4 /*yield*/, _super.prototype._setValue.call(this, "label", comps[0])];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.getFourtwentyLegacyRegistrar()];
                    case 3:
                        fourtwentyLegacyRegistrar = _a.sent();
                        return [4 /*yield*/, fourtwentyLegacyRegistrar.entries(fourtwentycoins_1.fourtwentycoins.utils.id(comps[0]))];
                    case 4:
                        entry = _a.sent();
                        ...
                        deed = new fourtwentycoins_1.fourtwentycoins.Contract(entry.owner, deedAbi, this.provider);
                        return [4 /*yield*/, deed.owner()];
                    case 5:
                        owner = _a.sent();
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Migrate Registrar: " + this.name, {
                            "Nodehash": this.nodehash,
                            "Highest Bid": (fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(this.highestBid) + " 420coin"),
                            "Deed Value": (fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(this.deedValue) + " 420coin"),
                        });
                        return [4 /*yield*/, this.getFourtwentyLegacyRegistrar()];
                    case 2:
                        legacyRegistrar = _a.sent();
                        return [4 /*yield*/, legacyRegistrar.transferRegistrars(fourtwentycoins_1.fourtwentycoins.utils.id(this.label))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        registrar = _a.sent();
                        return [4 /*yield*/, registrar.safeTransferFrom(this.accounts[0].getAddress(), this.new_owner, fourtwentycoins_1.fourtwentycoins.utils.id(this.label))];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, registrar.ownerOf(fourtwentycoins_1.fourtwentycoins.utils.id(comps[0]))];
                    case 4:
                        ownerOf = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        registrar = _a.sent();
                        return [4 /*yield*/, registrar.reclaim(fourtwentycoins_1.fourtwentycoins.utils.id(this.label), this.address)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
...
var RenewPlugin = /** @class */ (function (_super) {
    ...
    RenewPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fourtwentyController, fourtwentyRegistrar, i, label, expiration, duration, fee;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.run.call(this)];
                    case 1:
                    ...
                    case 4:
                        ...
                        label = this.labels[i];
                        console.log(label);
                        return [4 /*yield*/, fourtwentyRegistrar.nameExpires(fourtwentycoins_1.fourtwentycoins.utils.id(label))];
                    case 5:
                        ...
                        return [4 /*yield*/, fourtwentyController.rentPrice(label, duration)];
                    case 6:
                        fee = (_a.sent()).mul(11).div(10);
                        this.dump("Renew: " + label + ".fourtwenty", {
                            ...
                            "Fee": fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(fee) + " (+10% buffer)",
                        });
                        return [4 /*yield*/, fourtwentyController.renew(label, duration, {
                                value: fee
                            })];
                    case 7:
                        _a.sent();
...
//# sourceMappingURL=fourtwentycoins-ens.js.map