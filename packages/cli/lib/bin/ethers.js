...
function setupContext(path, context, plugin) {
    ...
    context.fourtwentycoins = fourtwentycoins_1.fourtwentycoins ;
    context.version = fourtwentycoins_1.fourtwentycoins.version;
    context.Contract = fourtwentycoins_1.fourtwentycoins.Contract;
    context.ContractFactory = fourtwentycoins_1.fourtwentycoins.ContractFactory;
    context.Wallet = fourtwentycoins_1.fourtwentycoins.Wallet;
    context.providers = fourtwentycoins_1.fourtwentycoins.providers;
    context.utils = fourtwentycoins_1.fourtwentycoins.utils;
    context.abiCoder = fourtwentycoins_1.fourtwentycoins.utils.defaultAbiCoder;
    context.BN = fourtwentycoins_1.fourtwentycoins.BigNumber;
    context.BigNumber = fourtwentycoins_1.fourtwentycoins.BigNumber;
    context.FixedNumber = fourtwentycoins_1.fourtwentycoins.FixedNumber;
    context.getAddress = fourtwentycoins_1.fourtwentycoins.utils.getAddress;
    context.getContractAddress = fourtwentycoins_1.fourtwentycoins.utils.getContractAddress;
    context.getIcapAddress = fourtwentycoins_1.fourtwentycoins.utils.getIcapAddress;
    context.arrayify = fourtwentycoins_1.fourtwentycoins.utils.arrayify;
    context.concat = fourtwentycoins_1.fourtwentycoins.utils.concat;
    context.hexlify = fourtwentycoins_1.fourtwentycoins.utils.hexlify;
    context.zeroPad = fourtwentycoins_1.fourtwentycoins.utils.zeroPad;
    context.joinSignature = fourtwentycoins_1.fourtwentycoins.utils.joinSignature;
    context.splitSignature = fourtwentycoins_1.fourtwentycoins.utils.splitSignature;
    context.id = fourtwentycoins_1.fourtwentycoins.utils.id;
    context.keccak256 = fourtwentycoins_1.fourtwentycoins.utils.keccak256;
    context.namehash = fourtwentycoins_1.fourtwentycoins.utils.namehash;
    context.sha256 = fourtwentycoins_1.fourtwentycoins.utils.sha256;
    context.parseFourtwentycoin = fourtwentycoins_1.fourtwentycoins.utils.parseFourtwentycoin;
    context.parseUnits = fourtwentycoins_1.fourtwentycoins.utils.parseUnits;
    context.formatFourtwentycoin = fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin;
    context.formatUnits = fourtwentycoins_1.fourtwentycoins.utils.formatUnits;
    context.randomBytes = fourtwentycoins_1.fourtwentycoins.utils.randomBytes;
    context.constants = fourtwentycoins_1.fourtwentycoins.constants;
    context.parseTransaction = fourtwentycoins_1.fourtwentycoins.utils.parseTransaction;
    context.serializeTransaction = fourtwentycoins_1.fourtwentycoins.utils.serializeTransaction;
    context.toUtf8Bytes = fourtwentycoins_1.fourtwentycoins.utils.toUtf8Bytes;
    context.toUtf8String = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String;
}
...
var SandboxPlugin = /** @class */ (function (_super) {
    ...
    SandboxPlugin.prototype.run = function () {
        console.log("version: " + fourtwentycoins_1.fourtwentycoins.version);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        wallet = fourtwentycoins_1.fourtwentycoins.Wallet.createRandom();
...
var FundPlugin = /** @class */ (function (_super) {
    ...
    FundPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                url = "https:/" + "/api.fourtwentycoins.io/api/v1/?action=fundAccount&address=" + this.toAddress.toLowerCase();
                return [2 /*return*/, fourtwentycoins_1.fourtwentycoins.utils.fetchJson(url).then(function (data) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        args.forEach(function (arg) {
                            if (fourtwentycoins_1.fourtwentycoins.utils.isAddress(arg)) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fourtwentycoins_1.fourtwentycoins.utils.resolveProperties({
                    ...
                    case 2:
                        ...
                        info = {
                            "Address": address,
                            "Balance": (fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(balance) + " 420coin"),
...
var SendPlugin = /** @class */ (function (_super) {
    ...
    SendPlugin.getHelp = function () {
        return {
            ...
            help: "Send FOURTWENTYCOIN fourtwentycoin to TARGET from accounts[0]"
        };
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.data = fourtwentycoins_1.fourtwentycoins.utils.hexlify(argParser.consumeOption("data") || "0x");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.value = fourtwentycoins_1.fourtwentycoins.utils.parseFourtwentycoin(args[1]);
                        return [2 /*return*/];
                }
            });
        });
...
var SweepPlugin = /** @class */ (function (_super) {
    ...
    SweepPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, balance, smokePrice, code, maxSpendable;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, fourtwentycoins_1.fourtwentycoins.utils.resolveProperties({
                    ...
                    case 1:
                        _a = _b.sent(), balance = _a.balance, smokePrice = _a.smokePrice, code = _a.code;
                        if (code !== "0x") {
                            this.throwError("Cannot sweep to a contract address");
                        }
                        maxSpendable = balance.sub(smokePrice.mul(21000));
...
var W420Address = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2";
var W420Abi = [
    "function deposit() payable",
    "function withdraw(uint wad)"
];
var WrapFourtwentycoinPlugin = /** @class */ (function (_super) {
    __extends(WrapFourtwentycoinPlugin, _super);
    function WrapFourtwentycoinPlugin() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    WrapFourtwentycoinPlugin.getHelp = function () {
        return {
            name: "wrap-fourtwentycoin VALUE",
            help: "Deposit VALUE into Wrapped 420coin (W420)"
        };
    };
    WrapFourtwentycoinPlugin.prototype.prepareArgs = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var address, balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.value = fourtwentycoins_1.fourtwentycoins.utils.parseFourtwentycoin(args[0]);
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                    case 2:
                        address = _a.sent();
                    ...
                    case 3:
                        ...
                        if (balance.lt(this.value)) {
                            this.throwError("insufficient 420coins to wrap");
                        }
                        return [2 /*return*/];
                }
            });
    ...
    WrapFourtwentycoinPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Wrapping fourtwentycoin", {
                            "From": address,
                            "Value": fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(this.value)
                        });
                        contract = new fourtwentycoins_1.fourtwentycoins.Contract(W420Address, W420Abi, this.accounts[0]);
    ...
    return WrapFourtwentycoinPlugin;
}(cli_1.Plugin));
cli.addPlugin("wrap-fourtwentycoin", WrapFourtwentycoinPlugin);
var UnwrapFourtwentycoinPlugin = /** @class */ (function (_super) {
    __extends(UnwrapFourtwentycoinPlugin, _super);
    function UnwrapFourtwentycoinPlugin() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UnwrapFourtwentycoinPlugin.getHelp = function () {
        return {
            name: "unwrap-fourtwentycoin VALUE",
            help: "Withdraw VALUE from Wrapped 420coin (W420)"
        };
    };
    UnwrapFourtwentycoinPlugin.prototype.prepareArgs = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.prepareArgs.call(this, args)];
    ...
    UnwrapFourtwentycoinPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var address, contract;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return UnwrapFourtwentycoinPlugin;
}(cli_1.Plugin));
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        this.contract = new fourtwentycoins_1.fourtwentycoins.Contract(tokenAddress, Erc20Abi, this.accounts[0]);
                        _a = this;
                    ...
                    case 4:
                        _b.toAddress = _c.sent();
                        this.value = fourtwentycoins_1.fourtwentycoins.utils.parseUnits(args[2], this.decimals);
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    case 0:
                        info = {
                            ...
                            "Value": fourtwentycoins_1.fourtwentycoins.utils.formatUnits(this.value, this.decimals)
                        };
                        namePromise = this.contract.name().then(function (name) {
                            ...
                            var contract = new fourtwentycoins_1.fourtwentycoins.Contract(_this.contract.address, Erc20AltAbi, _this.contract.signer);
                            contract.name().then(function (name) {
                                info["Token Name"] = fourtwentycoins_1.fourtwentycoins.utils.parseBytes32String(name);
                            }, function (error) {
                                throw error;
                            });
                        });
                        symbolPromise = this.contract.symbol().then(function (symbol) {
                            ...
                            contract.symbol().then(function (symbol) {
                                info["Token Symbol"] = fourtwentycoins_1.fourtwentycoins.utils.parseBytes32String(symbol);
                            }, function (error) {
                                throw error;
                            });
                        });
            ...
            return __generator(this, function (_a) {
                ...
                result.forEach(function (contract, index) {
                    output[contract.name] = {
                        ...
                        interface: contract.interface.fragments.map(function (f) { return f.format(fourtwentycoins_1.fourtwentycoins.utils.FormatTypes.full); }),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        factory = new fourtwentycoins_1.fourtwentycoins.ContractFactory(codes[0].interface, codes[0].bytecode, this.accounts[0]);
                        cli_1.dump("Deploying:", {
                            Contract: codes[0].name,
                            Bytecode: codes[0].bytecode,
                            Interface: codes[0].interface.fragments.map(function (f) { return f.format(fourtwentycoins_1.fourtwentycoins.utils.FormatTypes.full); }),
