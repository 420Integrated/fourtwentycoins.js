    ...
    getResolver(nodehash) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._fourtwentyAddressCache[nodehash]) {
                this._fourtwentyAddressCache[nodehash] = yield this.getEns().resolver(nodehash);
            }
            return new fourtwentycoins.Contract(this._fourtwentyAddressCache[nodehash], resolverAbi, this.accounts[0] || this.provider);
        });
    }
    getFourtwentyInterfaceAddress(interfaceId) {
        return __awaiter(this, void 0, void 0, function* () {
            let fourtwentyNodehash = fourtwentycoins.utils.namehash("fourtwenty");
            if (!this._fourtwentyAddressCache[interfaceId]) {
                let resolver = yield this.getResolver(fourtwentyNodehash);
                this._fourtwentyAddressCache[interfaceId] = yield resolver.interfaceImplementer(fourtwentyNodehash, interfaceId);
            }
            return this._fourtwentyAddressCache[interfaceId];
        });
    }
    getFourtwentyController() {
        return __awaiter(this, void 0, void 0, function* () {
            let address = yield this.getFourtwentyInterfaceAddress(InterfaceID_Controller);
            return new fourtwentycoins.Contract(address, fourtwentyControllerAbi, this.accounts[0] || this.provider);
        });
    }
    getFourtwentyLegacyRegistrar() {
        return __awaiter(this, void 0, void 0, function* () {
            let address = yield this.getFourtwentyInterfaceAddress(InterfaceID_Legacy);
            return new fourtwentycoins.Contract(address, fourtwentyLegacyRegistrarAbi, this.accounts[0] || this.provider);
        });
    }
    getFourtwentyRegistrar() {
        return __awaiter(this, void 0, void 0, function* () {
            //let address = await this.getFourtwentyInterfaceAddress(InterfaceID_ERC721);
            let address = yield this.getEns().owner(fourtwentycoins.utils.namehash("fourtwenty"));
...
class LookupPlugin extends EnsPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let ens = this.getEns();
            let controller = yield this.getFourtwentyController();
            let registrar = yield this.getFourtwentyRegistrar();
            let legacyRegistrar = yield this.getFourtwentyLegacyRegistrar();
...
class AccountPlugin extends EnsPlugin {
    ...
    _setValue(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            fourtwentycoins.utils.defineReadOnly(this, key, value);
            if (key === "name") {
                yield this._setValue("nodehash", fourtwentycoins.utils.namehash(value));
            }
        });
    }
    prepareArgs(args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield _super.prepareArgs.call(this, args);
            let helpLine = fourtwentycoins.utils.getStatic(this.constructor, "getHelp")().name;
...
class CommitPlugin extends ControllerPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield _super.run.call(this);
            let fourtwentyController = yield this.getFourtwentyController();
            let commitment = yield fourtwentyController.makeCommitment(this.label, this.owner, this.salt);
            let fee = yield fourtwentyController.rentPrice(this.label, this.duration);
            ...
            yield fourtwentyController.commit(commitment);
        });
    }
}
...
class RevealPlugin extends ControllerPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield fourtwentyController.register(this.label, this.owner, this.duration, this.salt, {
...
class SetSubnodePlugin extends AddressAccountPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.getEns().setSubnodeOwner(fourtwentycoins.utils.namehash(this.node), fourtwentycoins.utils.id(this.label), this.address);
        });
    }
}
    ...
    _setValue(key, value) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (key === "hash") {
                ...
                yield _super._setValue.call(this, "multihash", fourtwentycoins.utils.hexlify(multihash));
            }
            yield _super._setValue.call(this, key, value);
        });
    }
...
class MigrateRegistrarPlugin extends AccountPlugin {
    ...
    prepareArgs(args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield _super._setValue.call(this, "label", comps[0]);
            let fourtwentyLegacyRegistrar = yield this.getFourtwentyLegacyRegistrar();
            let entry = yield fourtwentyLegacyRegistrar.entries(fourtwentycoins.utils.id(comps[0]));
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let legacyRegistrar = yield this.getFourtwentyLegacyRegistrar();
            yield legacyRegistrar.transferRegistrars(fourtwentycoins.utils.id(this.label));
        });
    }
}
...
class TransferPlugin extends AccountPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let registrar = yield this.getFourtwentyRegistrar();
            yield registrar.safeTransferFrom(this.accounts[0].getAddress(), this.new_owner, fourtwentycoins.utils.id(this.label));
        });
    }
}
...
class ReclaimPlugin extends AddressAccountPlugin {
    ...
    _setValue(key, value) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (key === "name") {
                ...
                let ownerOf = null;
                try {
                    ownerOf = yield registrar.ownerOf(fourtwentycoins.utils.id(comps[0]));
                }
                catch (error) {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let registrar = yield this.getFourtwentyRegistrar();
            yield registrar.reclaim(fourtwentycoins.utils.id(this.label), this.address);
        });
    }
}
...
class RenewPlugin extends EnsPlugin {
    ...
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield _super.run.call(this);
            const fourtwentyController = yield this.getFourtwentyController();
            const fourtwentyRegistrar = yield this.getFourtwentyRegistrar();
            for (let i = 0; i < this.labels.length; i++) {
                const label = this.labels[i];
                console.log(label);
                const expiration = (yield fourtwentyRegistrar.nameExpires(fourtwentycoins.utils.id(label))).toNumber();
                if (expiration === 0) {
                ...
                const fee = (yield fourtwentyController.rentPrice(label, duration)).mul(11).div(10);
                ...
                yield fourtwentyController.renew(label, duration, {
                    value: fee
                });
            }
        });
