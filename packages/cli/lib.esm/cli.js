...
class WrappedSigner extends fourtwentycoins.Signer {
    ...
    signTransaction(transactionRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let tx = yield fourtwentycoins.utils.resolveProperties(transactionRequest);
            let info = {};
            if (tx.to != null) {
                info["To"] = tx.to;
            }
    ...
    sendTransaction(transactionRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            tx = yield fourtwentycoins.utils.resolveProperties(tx);
            let info = {};
            if (tx.to != null) {
                info["To"] = tx.to;
            }
...
export class CLI {
    ...
    showUsage(message, status) {
        ...
        console.log("Usage:");
        if (this.standAlone) {
            let help = fourtwentycoins.utils.getStatic(this.standAlone, "getHelp")();
            console.log(`   ${CLI.getAppName()} ${help.name} [ OPTIONS ]`);
            console.log("");
            let lines = [];
            let optionHelp = fourtwentycoins.utils.getStatic(this.standAlone, "getOptionHelp")();
            ...
            for (let cmd in this.plugins) {
                ...
                let help = fourtwentycoins.utils.getStatic(plugin, "getHelp")();
                if (help == null) {
                    continue;
                }
                ...
                let optionHelp = fourtwentycoins.utils.getStatic(plugin, "getOptionHelp")();
                optionHelp.forEach((help) => {
