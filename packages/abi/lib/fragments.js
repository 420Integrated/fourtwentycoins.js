...
function parseSmoke(value, params) {
    ...
    if (comps.length !== 1) {
        ...
        if (!comps[1].match(/^[0-9]+$/)) {
            logger.throwArgumentError("invalid human-readable ABI signature smoke", "value", value);
        }
        params.smoke = bignumber_1.BigNumber.from(comps[1]);
        return comps[0];
    }
    return value;
}
...
var ConstructorFragment = /** @class */ (function (_super) {
    ...
    ConstructorFragment.fromObject = function (value) {
        ...
        var params = {
            ...
            smoke: (value.smoke ? bignumber_1.BigNumber.from(value.smoke) : null)
        };
