...
var abi_1 = require("@420integrated/abi");
var abstract_provider_1 = require("@420integrated/abstract-provider");
var abstract_signer_1 = require("@420integrated/abstract-signer");
var address_1 = require("@420integrated/address");
var bignumber_1 = require("@420integrated/bignumber");
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (ro.smokeLimit != null) {
                        tx.smokeLimit = bignumber_1.BigNumber.from(ro.smokeLimit);
                    }
                    if (ro.smokePrice != null) {
                        tx.smokePrice = bignumber_1.BigNumber.from(ro.smokePrice);
                    }
                    if (ro.from != null) {
                        tx.from = ro.from;
                    }
                    ...
                    if (tx.smokeLimit == null && fragment.smoke != null) {
                        ...
                        tx.smokeLimit = bignumber_1.BigNumber.from(fragment.smoke).add(intrinsic);
                    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tx = _a.sent();
                        return [4 /*yield*/, signerOrProvider.estimateSmoke(tx)];
...
var Contract = /** @class */ (function () {
    function Contract(addressOrName, contractInterface, signerOrProvider) {
        ...
        properties_1.defineReadOnly(this, "estimateSmoke", {});
        ...
        Object.keys(this.interface.functions).forEach(function (signature) {
            ...
            if (_this.estimateSmoke[signature] == null) {
                properties_1.defineReadOnly(_this.estimateSmoke, signature, buildEstimate(_this, fragment));
            }
        });
        Object.keys(uniqueNames).forEach(function (name) {
            ...
            if (_this.estimateSmoke[name] == null) {
                properties_1.defineReadOnly(_this.estimateSmoke, name, _this.estimateSmoke[signature]);
            }
        });
    }
