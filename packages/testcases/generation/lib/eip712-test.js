...
const fourtwenty_sig_util_1 = require("fourtwenty-sig-util");
...
function fill(testcase) {
    ...
    testcase.encoded = "0x" + fourtwenty_sig_util_1.TypedDataUtils.encodeData(testcase.primaryType, testcase.data, testcase.types).toString("hex");
    testcase.digest = "0x" + fourtwenty_sig_util_1.TypedDataUtils.sign({
