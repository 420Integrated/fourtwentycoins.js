...
(function () {
    ...
    addErrorTest(fourtwentycoins.utils.Logger.errors.NONCE_EXPIRED, (provider) => __awaiter(this, void 0, void 0, function* () {
    ...
    addErrorTest(fourtwentycoins.utils.Logger.errors.INSUFFICIENT_FUNDS, (provider) => __awaiter(this, void 0, void 0, function* () {
        const txProps = {
    ...
    addErrorTest(fourtwentycoins.utils.Logger.errors.UNPREDICTABLE_SMOKE_LIMIT, (provider) => __awaiter(this, void 0, void 0, function* () {
...
describe("Test Provider Methods", function () {
    ...
    before(function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const funder = yield fourtwentycoins.utils.fetchJson(`https:/\/api.fourtwentycoins.io/api/v1/?action=fundAccount&address=${fundWallet.address.toLowerCase()}`);
    ...
    after(function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const provider = new fourtwentycoins.providers.InfuraProvider("ropsten", ApiKeys.infura);
            const smokePrice = yield provider.getSmokePrice();
