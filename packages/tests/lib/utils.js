...
function randomBytes(seed, lower, upper) {
    ...
    while (result.length < upper) {
        result = fourtwentycoins_1.fourtwentycoins.utils.concat([result, fourtwentycoins_1.fourtwentycoins.utils.keccak256(fourtwentycoins_1.fourtwentycoins.utils.concat([seed, result]))]);
    }
