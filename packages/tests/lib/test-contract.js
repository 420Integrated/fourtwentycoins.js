...
var provider = new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider("rinkeby", "49a0efa3aaee4fd99797bfa94d8ce2f1");
//const provider = fourtwentycoins.getDefaultProvider("rinkeby");
var TIMEOUT_PERIOD = 120000;
var contract = (function () {
    return new fourtwentycoins_1.fourtwentycoins.Contract(test_contract_json_1.default.contractAddress, test_contract_json_1.default.interface, provider);
})();
function equals(name, actual, expected) {
    ...
    if (typeof (actual) === 'object') {
        if (expected.indexed) {
            assert_1.default.ok(fourtwentycoins_1.fourtwentycoins.Contract.isIndexed(actual), 'index property has index - ' + name);
            if (expected.hash) {
...
function TestContractEvents() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fourtwentycoins_1.fourtwentycoins.utils.fetchJson('https://api.fourtwentycoins.io/api/v1/?action=triggerTest&address=' + contract.address)];
                case 1:
                    data = _a.sent();
...
describe("Test Contract Transaction Population", function () {
    ...
    var contract = new fourtwentycoins_1.fourtwentycoins.Contract(testAddress, abi);
    var contractConnected = contract.connect(fourtwentycoins_1.fourtwentycoins.getDefaultProvider());
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, contractConnected.populateTransaction.balanceOf(testAddress, {
                                from: "ricmoo.firefly.fourtwenty"
                            })];
                    case 1:
                        tx = _a.sent();
                        //console.log(tx);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        assert_1.default.ok(tx.smokeLimit.eq(150000), "smokeLimit matches");
                        assert_1.default.ok(tx.smokePrice.eq(1900000000), "smokePrice matches");
