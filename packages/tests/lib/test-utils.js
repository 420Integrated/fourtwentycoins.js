...
describe('Test Contract Address Generation', function () {
    ...
    var getContractAddress = fourtwentycoins_1.fourtwentycoins.utils.getContractAddress;
    var Tests = [
...
describe('Test RLP Coder', function () {
    ...
    tests.forEach(function (test) {
        it(('RLP coder encoded - ' + test.name), function () {
            this.timeout(120000);
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.RLP.encode(test.decoded), test.encoded, 'RLP encoded - ' + test.name);
        });
    });
    tests.forEach(function (test) {
        it(('RLP coder decoded - ' + test.name), function () {
            this.timeout(120000);
            assert_1.default.ok(equals(fourtwentycoins_1.fourtwentycoins.utils.RLP.decode(test.encoded), test.decoded), 'RLP decoded - ' + test.name);
        });
    });
});
describe('Test Unit Conversion', function () {
    ...
    tests.forEach(function (test) {
        var marley = fourtwentycoins_1.fourtwentycoins.BigNumber.from(test.marley);
        it(('parses ' + test.fourtwentycoin + ' fourtwentycoin'), function () {
            assert_1.default.ok(fourtwentycoins_1.fourtwentycoins.utils.parseFourtwentycoin(test.420coin.replace(/,/g, '')).eq(marley), 'parsing ether failed - ' + test.name);
        });
        it(('formats ' + marley.toString() + ' marley to fourtwentycoin'), function () {
            var actual = fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin(marley);
            assert_1.default.equal(actual, test.fourtwentycoin_format, 'formatting marley failed - ' + test.name);
        });
    });
    tests.forEach(function (test) {
        var marley = fourtwentycoins_1.fourtwentycoins.BigNumber.from(test.marley);
        ['kmarley', 'mmarley', 'gmarley', 'snoop', 'willie', 'satoshi'].forEach(function (name) {
            var unitName = name;
            if (name === 'satoshi') {
                unitName = 8;
            }
            if (test[name]) {
                it(('parses ' + test[name] + ' ' + name), function () {
                    this.timeout(120000);
                    assert_1.default.ok(fourtwentycoins_1.fourtwentycoins.utils.parseUnits(test[name].replace(/,/g, ''), unitName).eq(marley), ('parsing ' + name + ' failed - ' + test.name));
                });
            }
            var expectedKey = (name + '_format');
            if (test[expectedKey]) {
                it(('formats ' + marley.toString() + ' marley to ' + name + ')'), function () {
                    var actual = fourtwentycoins_1.fourtwentycoins.utils.formatUnits(marley, unitName);
    ...
    it("formats with commify", function () {
        ...
        Object.keys(tests).forEach(function (test) {
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.commify(test), tests[test]);
        });
    });
});
describe('Test Namehash', function () {
    ...
    tests.forEach(function (test) {
        it(('computes namehash - "' + test.name + '"'), function () {
            this.timeout(120000);
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.namehash(test.name), test.expected, 'computes namehash(' + test.name + ')');
        });
    });
    it("isValidName", function () {
        assert_1.default.ok(fourtwentycoins_1.fourtwentycoins.utils.isValidName("ricmoo.fourtwenty"));
        assert_1.default.ok(!fourtwentycoins_1.fourtwentycoins.utils.isValidName(""));
        assert_1.default.ok(!fourtwentycoins_1.fourtwentycoins.utils.isValidName("ricmoo..fourtwenty"));
    });
});
describe('Test ID Hash Functions', function () {
    ...
    tests.forEach(function (test) {
        it(('computes id - ' + test.name), function () {
            this.timeout(120000);
            var actual = fourtwentycoins_1.fourtwentycoins.utils.id(test.text);
    ...
    function test(funcName, testKey) {
        it("computes " + funcName + " correctly", function () {
            ...
            tests.forEach(function (test, index) {
                var actual = (fourtwentycoins_1.fourtwentycoins.utils)['solidity' + funcName](test.types, test.values);
    ...
    testsInvalid.forEach(function (type) {
        it("disallows invalid type \"" + type + "\"", function () {
            assert_1.default.throws(function () {
                fourtwentycoins_1.fourtwentycoins.utils.solidityPack([type], ["0x12"]);
            }, function (error) {
...
describe('Test Hash Functions', function () {
    ...
    it('computes keccak256 correctly', function () {
        this.timeout(120000);
        tests.forEach(function (test) {
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.keccak256(test.data), test.keccak256, ('Keccak256 - ' + test.data));
        });
    });
    it('computes sha2-256 correctly', function () {
        this.timeout(120000);
        tests.forEach(function (test) {
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.sha256(test.data), test.sha256, ('SHA256 - ' + test.data));
        });
    });
    it('computes sha2-512 correctly', function () {
        this.timeout(120000);
        tests.forEach(function (test) {
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.sha512(test.data), test.sha512, ('SHA512 - ' + test.data));
        });
    });
});
describe('Test Solidity splitSignature', function () {
    it('splits a canonical signature', function () {
        ...
        for (var v = 27; v <= 28; v++) {
            var signature = fourtwentycoins_1.fourtwentycoins.utils.concat([r, s, [v]]);
            var sig = fourtwentycoins_1.fourtwentycoins.utils.splitSignature(signature);
    ...
    it('splits a legacy signature', function () {
        ...
        var s = '0xcafe1a7ecafe1a7ecafe1a7ecafe1a7ecafe1a7ecafe1a7ecafe1a7ecafe1a7e';
        for (var v = 27; v <= 28; v++) {
            var signature = fourtwentycoins_1.fourtwentycoins.utils.concat([r, s, [v - 27]]);
            var sig = fourtwentycoins_1.fourtwentycoins.utils.splitSignature(signature);
            assert_1.default.equal(sig.r, r, 'split r correctly');
            assert_1.default.equal(sig.s, s, 'split s correctly');
            assert_1.default.equal(sig.v, v, 'split v correctly');
...
describe('Test Base64 coder', function () {
    ...
    it('encodes and decodes the example from wikipedia', function () {
        ...
        var decoded = fourtwentycoins_1.fourtwentycoins.utils.toUtf8Bytes(decodedText);
        ...
        assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.base64.encode(decoded), encoded, 'encodes to base64 string');
        assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(fourtwentycoins_1.fourtwentycoins.utils.base64.decode(encoded)), decodedText, 'decodes from base64 string');
    });
});
describe('Test UTF-8 coder', function () {
    var overlong = fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorReason.OVERLONG;
    var utf16Surrogate = fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorReason.UTF16_SURROGATE;
    var overrun = fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorReason.OVERRUN;
    var missingContinue = fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorReason.MISSING_CONTINUE;
    var unexpectedContinue = fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorReason.UNEXPECTED_CONTINUE;
    var outOfRange = fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorReason.OUT_OF_RANGE;
    var BadUTF = [
    ...
    BadUTF.forEach(function (test) {
        it('toUtf8String - ' + test.name, function () {
            ...
            var ignored = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(test.bytes, fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorFuncs.ignore);
            assert_1.default.equal(ignored, test.ignored, "ignoring errors matches");
            // Check the string using the replaceErrors conversion
            var replaced = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(test.bytes, fourtwentycoins_1.fourtwentycoins.utils.Utf8ErrorFuncs.replace);
            ...
            assert_1.default.throws(function () {
                var result = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(test.bytes);
    ...
    it('toUtf8String - random conversions', function () {
        ...
        for (var i = 0; i < 100000; i++) {
            ...
            var bytes = fourtwentycoins_1.fourtwentycoins.utils.toUtf8Bytes(str);
            var str2 = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(bytes);
            var escaped = JSON.parse(fourtwentycoins_1.fourtwentycoins.utils._toEscapedUtf8String(bytes));
...
describe('Test Bytes32String coder', function () {
    ...
    it("encodes an ens name", function () {
        var str = "ricmoo.firefly.fourtwenty";
        var bytes32 = fourtwentycoins_1.fourtwentycoins.utils.formatBytes32String(str);
        var str2 = fourtwentycoins_1.fourtwentycoins.utils.parseBytes32String(bytes32);
...
describe("Test nameprep", function () {
    ...
    Tests.forEach(function (test) {
        ...
        it(test.comment, function () {
            var input = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(test.input);
            if (test.output) {
                var expected = fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(test.output);
                var actual = fourtwentycoins_1.fourtwentycoins.utils.nameprep(input);
...
describe("Test Signature Manipulation", function () {
    ...
    tests.forEach(function (test) {
        it("autofills partial signatures - " + test.name, function () {
            var address = fourtwentycoins_1.fourtwentycoins.utils.getAddress(test.accountAddress);
            var hash = fourtwentycoins_1.fourtwentycoins.utils.keccak256(test.unsignedTransaction);
            var data = fourtwentycoins_1.fourtwentycoins.utils.RLP.decode(test.signedTransaction);
            var s = data.pop(), r = data.pop(), v = parseInt(data.pop().substring(2), 16);
            var sig = fourtwentycoins_1.fourtwentycoins.utils.splitSignature({ r: r, s: s, v: v });
            {
                var addr = fourtwentycoins_1.fourtwentycoins.utils.recoverAddress(hash, {
                    r: r, s: s, v: v
                });
...
describe("BigNumber", function () {
    ...
    tests.forEach(function (test) {
        if (test.expectedValue == null) {
            it(test.testcase, function () {
                assert_1.default.throws(function () {
                    var value = fourtwentycoins_1.fourtwentycoins.BigNumber.from(test.value);
            ...
            it(test.testcase, function () {
                ...
                var value2 = fourtwentycoins_1.fourtwentycoins.BigNumber.from(value);
    ...
    [
        ...
        it("absolute value (" + test.value + ")", function () {
            var value = fourtwentycoins_1.fourtwentycoins.BigNumber.from(test.value);
            var expected = fourtwentycoins_1.fourtwentycoins.BigNumber.from(test.expected);
...
describe("FixedNumber", function () {
    {
        ...
        Tests.forEach(function (test) {
            it("Create from=" + test.value, function () {
                var value = fourtwentycoins_1.fourtwentycoins.FixedNumber.from(test.value);
    ...
    }
    {
        ...
        Tests.forEach(function (test) {
            it("Rounding value=" + test.value + ", decimals=" + test.round, function () {
                var value = fourtwentycoins_1.fourtwentycoins.FixedNumber.from(test.value).round(test.round);
                assert_1.default.equal(value.toString(), test.expected);
            });
        });
    }
...
describe("Logger", function () {
    var logger = new fourtwentycoins_1.fourtwentycoins.utils.Logger("testing/0.0");
    it("setLogLevel", function () {
        fourtwentycoins_1.fourtwentycoins.utils.Logger.setLogLevel(fourtwentycoins_1.fourtwentycoins.utils.Logger.levels.DEBUG);
        fourtwentycoins_1.fourtwentycoins.utils.Logger.setLogLevel(fourtwentycoins_1.fourtwentycoins.utils.Logger.levels.INFO);
        fourtwentycoins_1.fourtwentycoins.utils.Logger.setLogLevel(fourtwentycoins_1.fourtwentycoins.utils.Logger.levels.WARNING);
        fourtwentycoins_1.fourtwentycoins.utils.Logger.setLogLevel(fourtwentycoins_1.fourtwentycoins.utils.Logger.levels.ERROR);
        fourtwentycoins_1.fourtwentycoins.utils.Logger.setLogLevel(fourtwentycoins_1.fourtwentycoins.utils.Logger.levels.OFF);
    ...
    it("checkArgumentCount - too few", function () {
        assert_1.default.throws(function () {
            ...
            return error.code === fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.MISSING_ARGUMENT;
        });
    });
    it("checkArgumentCount - too many", function () {
        assert_1.default.throws(function () {
            ...
            return error.code === fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.UNEXPECTED_ARGUMENT;
        });
    });
});
describe("Base58 Coder", function () {
    it("decodes", function () {
        assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.toUtf8String(fourtwentycoins_1.fourtwentycoins.utils.base58.decode("JxF12TrwUP45BMd")), "Hello World");
    });
    it("encodes", function () {
        assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.base58.encode(fourtwentycoins_1.fourtwentycoins.utils.toUtf8Bytes("Hello World")), "JxF12TrwUP45BMd");
    });
});
/*
...
describe("EIP-712", function () {
    ...
    tests.forEach(function (test) {
        it("encoding " + test.name, function () {
            var encoder = fourtwentycoins_1.fourtwentycoins.utils._TypedDataEncoder.from(test.types);
            ...
            //console.log(test);
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils._TypedDataEncoder.getPrimaryType(test.types), test.primaryType, "getPrimaryType");
            assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils._TypedDataEncoder.hash(test.domain, test.types, test.data), test.digest, "digest");
        });
    });
    tests.forEach(function (test) {
        if (!test.privateKey) {
        ...
        it("signing " + test.name, function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            wallet = new fourtwentycoins_1.fourtwentycoins.Wallet(test.privateKey);
