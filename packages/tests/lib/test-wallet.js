...
describe('Test JSON Wallets', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (test.hasAddress) {
                                assert_1.default.ok((fourtwentycoins_1.fourtwentycoins.utils.getJsonWalletAddress(test.json) !== null), 'detect encrypted JSON wallet');
                            }
                            return [4 /*yield*/, fourtwentycoins_1.fourtwentycoins.Wallet.fromEncryptedJson(test.json, test.password)];
                        case 1:
                            wallet = _a.sent();
                        ...
                        case 2:
                            ...
                            // Test connect
                            {
                                provider = new fourtwentycoins_1.fourtwentycoins.providers.FourtwentyvmProvider();
                            ...
                            {
                                wallet2 = new fourtwentycoins_1.fourtwentycoins.Wallet(wallet._signingKey());
                            ...
                            if (test.name === "life") {
                                wallet2 = fourtwentycoins_1.fourtwentycoins.Wallet.fromEncryptedJsonSync(test.json, test.password);
                                assert_1.default.equal(wallet2.privateKey, test.privateKey, 'generated correct private key - ' + wallet2.privateKey);
                            }
                            if (test.mnemonic) {
    ...
    ['one', 'two', 'three'].forEach(function (i) {
        ...
        var wallet = fourtwentycoins_1.fourtwentycoins.Wallet.createRandom({ path: "m/56'/82", extraEntropy: utils.randomHexString('test-' + i, 32) });
        it('encrypts and decrypts a random wallet - ' + i, function () {
            this.timeout(1200000);
            return wallet.encrypt(password).then(function (json) {
                return fourtwentycoins_1.fourtwentycoins.Wallet.fromEncryptedJson(json, password).then(function (decryptedWallet) {
...
describe('Test Transaction Signing and Parsing', function () {
    function checkTransaction(parsedTransaction, test) {
        var transaction = {};
        ['nonce', 'smokeLimit', 'smokePrice', 'to', 'value', 'data'].forEach(function (key) {
            var expected = test[key];
            var value = parsedTransaction[key];
            if (["smokeLimit", "smokePrice", "value"].indexOf(key) >= 0) {
                assert_1.default.ok((fourtwentycoins_1.fourtwentycoins.BigNumber.isBigNumber(value)), 'parsed into a big number - ' + key);
                ...
                value = fourtwentycoins_1.fourtwentycoins.utils.hexlify(value);
                if (!expected || expected === '0x') {
                    expected = '0x00';
                }
            }
                ...
                if (value) {
                    ...
                    fourtwentycoins_1.fourtwentycoins.utils.getAddress(value);
    ...
    tests.forEach(function (test) {
        it(('parses and signs transaction - ' + test.name), function () {
            this.timeout(120000);
            var signingKey = new fourtwentycoins_1.fourtwentycoins.utils.SigningKey(test.privateKey);
            var signDigest = signingKey.signDigest.bind(signingKey);
            // Legacy parsing unsigned transaction
            checkTransaction(fourtwentycoins_1.fourtwentycoins.utils.parseTransaction(test.unsignedTransaction), test);
            var parsedTransaction = fourtwentycoins_1.fourtwentycoins.utils.parseTransaction(test.signedTransaction);
            var transaction = checkTransaction(parsedTransaction, test);
            // Legacy signed transaction ecrecover
            assert_1.default.equal(parsedTransaction.from, fourtwentycoins_1.fourtwentycoins.utils.getAddress(test.accountAddress), 'computed from');
            ...
            (function () {
                var unsignedTx = fourtwentycoins_1.fourtwentycoins.utils.serializeTransaction(transaction);
                ...
                var signature = signDigest(fourtwentycoins_1.fourtwentycoins.utils.keccak256(unsignedTx));
                assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.serializeTransaction(transaction, signature), test.signedTransaction, 'signs transaction (legacy)');
            })();
            // EIP155
            // EIP-155 parsing unsigned transaction
            var parsedUnsignedTransactionChainId5 = fourtwentycoins_1.fourtwentycoins.utils.parseTransaction(test.unsignedTransactionChainId5);
            ...
            // EIP-155 fields
            var parsedTransactionChainId5 = fourtwentycoins_1.fourtwentycoins.utils.parseTransaction(test.signedTransactionChainId5);
            ...
            ['smokeLimit', 'smokePrice', 'value'].forEach(function (key) {
            ...
            (function () {
                ...
                var signature = signDigest(fourtwentycoins_1.fourtwentycoins.utils.keccak256(unsignedTx));
                assert_1.default.equal(fourtwentycoins_1.fourtwentycoins.utils.serializeTransaction(transaction, signature), test.signedTransactionChainId5, 'signs transaction (eip155)');
            })();
        });
    });
    tests.forEach(function (test) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            transaction = {
                                to: test.to,
                                data: test.data,
                                smokeLimit: test.smokeLimit,
                                smokePrice: test.smokePrice,
                                value: test.value,
...
describe('Test Signing Messages', function () {
    var tests = [
        // See: https://fourtwentyvm.io/verifySig/57
        {
        ...
        // See: https://github.com/420integrated/fourtwentycoins.js/issues/80
        {
            address: '0xD351c7c627ad5531Edb9587f4150CaF393c33E87',
            name: 'bytes(0x47173285...4cb01fad)',
            message: fourtwentycoins_1.fourtwentycoins.utils.arrayify('0x47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad'),
        ...
        // See: https://github.com/420integrated/fourtwentycoins.js/issues/85
        {
            address: '0xe7deA7e64B62d1Ca52f1716f29cd27d4FE28e3e1',
            name: 'zero-prefixed signature',
            message: fourtwentycoins_1.fourtwentycoins.utils.arrayify(fourtwentycoins_1.fourtwentycoins.utils.id('0x7f23b5eed5bc7e89f267f339561b2697faab234a2')),
    ...
    tests.forEach(function (test) {
        it(('verifies a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var address = fourtwentycoins_1.fourtwentycoins.utils.verifyMessage(test.message, test.signature);
    ...
    tests.forEach(function (test) {
        it(('hashes a message "' + test.name + '"'), function () {
            this.timeout(120000);
            var hash = fourtwentycoins_1.fourtwentycoins.utils.hashMessage(test.message);
...
describe("Serialize Transactions", function () {
    it("allows odd-length numeric values", function () {
        fourtwentycoins_1.fourtwentycoins.utils.serializeTransaction({
            smokeLimit: "0x1",
            smokePrice: "0x1",
            value: "0x1"
        });
...
describe("Wallet Errors", function () {
    it("fails on privateKey/address mismatch", function () {
        assert_1.default.throws(function () {
            var wallet = new fourtwentycoins_1.fourtwentycoins.Wallet({
    ...
    it("fails on from mismatch", function () {
        var _this = this;
        var wallet = new fourtwentycoins_1.fourtwentycoins.Wallet("0x6a73cd9b03647e83ef937888a5258a26e4c766dbf41ddd974f15e32d09cfe9c0");
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        if (error_1.code === fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.INVALID_ARGUMENT && error_1.argument === "transaction.from") {
                            resolve(true);
                            return [2 /*return*/];
                        }
                        return [3 /*break*/, 3];
