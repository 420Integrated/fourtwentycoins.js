...
var bnify = fourtwentycoins_1.fourtwentycoins.BigNumber.from;
var blockchainData = {
    homestead: {
        addresses: [
            {
...
function equals(name, actual, expected) {
    if (expected && expected.eq) {
        ...
        expected = fourtwentycoins_1.fourtwentycoins.BigNumber.from(expected);
        actual = fourtwentycoins_1.fourtwentycoins.BigNumber.from(actual);
...
var providerFunctions = [
    {
        ...
        create: function (network) {
            if (network == "default") {
                return fourtwentycoins_1.fourtwentycoins.getDefaultProvider(null, ApiKeys);
            }
            return fourtwentycoins_1.fourtwentycoins.getDefaultProvider(network, ApiKeys);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new fourtwentycoins_1.fourtwentycoins.providers.AlchemyProvider(null, ApiKeys.alchemy);
            }
            return new fourtwentycoins_1.fourtwentycoins.providers.AlchemyProvider(network, ApiKeys.alchemy);
        }
    },
    /*
    {
    ...
    */
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider(null, ApiKeys.infura);
            }
            return new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider(network, ApiKeys.infura);
        }
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new fourtwentycoins_1.fourtwentycoins.providers.FourtwentyvmProvider(null, ApiKeys.fourtwentyvm);
            }
            return new fourtwentycoins_1.fourtwentycoins.providers.FourtwentyvmProvider(network, ApiKeys.fourtwentyvm);
        }
    },
    {
    ...
    },
    {
        ...
        create: function (network) {
            if (network == "default") {
                return new fourtwentycoins_1.fourtwentycoins.providers.PocketProvider(null, ApiKeys.pocket);
            }
            return new fourtwentycoins_1.fourtwentycoins.providers.PocketProvider(network, ApiKeys.pocket);
        }
    },
    {
        name: "Web3Provider",
...
var fundWallet = fourtwentycoins_1.fourtwentycoins.Wallet.createRandom();
var testFunctions = [];
...
(function () {
    ...
    addErrorTest(fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.NONCE_EXPIRED, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    addErrorTest(fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
    ...
    addErrorTest(fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.INSUFFICIENT_FUNDS, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            wallet = fourtwentycoins_1.fourtwentycoins.Wallet.createRandom().connect(provider);
            return [2 /*return*/, wallet.sendTransaction(txProps)];
        });
    }); });
    addErrorTest(fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.UNPREDICTABLE_SMOKE_LIMIT, function (provider) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, provider.estimateSmoke({
    ...
    execute: function (provider) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    b0 = _a.sent();
                    assert_1.default.ok(b0.gt(fourtwentycoins_1.fourtwentycoins.constants.Zero), "balance is non-zero");
...
describe("Test Provider Methods", function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                        provider = new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider("ropsten", ApiKeys.infura);
                        return [4 /*yield*/, fourtwentycoins_1.fourtwentycoins.utils.fetchJson("https://api.fourtwentycoins.io/api/v1/?action=fundAccount&address=" + fundWallet.address.toLowerCase())];
                    case 1:
                        funder = _a.sent();
    ...
    after(function () {
        return __awaiter(this, void 0, void 0, function () {
            var provider, smokePrice, balance, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(300000);
                    ...
                    case 1:
                        ...
                        _a.sent();
                        provider = new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider("ropsten", ApiKeys.infura);
                        return [4 /*yield*/, provider.getSmokePrice()];
                    case 2:
                        smokePrice = _a.sent();
...
describe("Extra tests", function () {
    it("fourtwentyvm long-request #1093", function () {
        return __awaiter(this, void 0, void 0, function () {
            var provider, value;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        provider = new fourtwentycoins_1.fourtwentycoins.providers.FourtwentyvmProvider(null, ApiKeys.fourtwentyvm);
...
describe("Test Basic Authentication", function () {
    ...
    function test(name, url) {
        it("tests " + name, function () {
            this.timeout(60000);
            return fourtwentycoins_1.fourtwentycoins.utils.fetchJson(url).then(function (data) {
    ...
    it("tests insecure connections fail", function () {
        ...
        assert_1.default.throws(function () {
            return fourtwentycoins_1.fourtwentycoins.utils.fetchJson(insecure);
        }, function (error) {
...
describe("Test API Key Formatting", function () {
    it("Infura API Key", function () {
        ...
        var apiKeyString = fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider.getApiKey(projectId);
        ...
        var apiKeyObject = fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider.getApiKey({
            projectId: projectId
        });
        ...
        var apiKeyObject2 = fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider.getApiKey({
            projectId: projectId,
        ...
        assert_1.default.throws(function () {
            var apiKey = fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider.getApiKey({
                projectId: 1234,
                projectSecret: projectSecret
            });
            console.log(apiKey);
        ...
        {
            var provider = new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider("homestead", {
                projectId: projectId,
                projectSecret: projectSecret
            });
        ...
        assert_1.default.throws(function () {
            var provider = new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider("imaginary");
    ...
    it("Pocket API key", function () {
        ...
        var apiKeyString = fourtwentycoins_1.fourtwentycoins.providers.PocketProvider.getApiKey(applicationId);
        ...
        var apiKeyObject = fourtwentycoins_1.fourtwentycoins.providers.PocketProvider.getApiKey({
        ...
        var apiKeyObject2 = fourtwentycoins_1.fourtwentycoins.providers.PocketProvider.getApiKey({
            applicationId: applicationId,
        ...
        assert_1.default.throws(function () {
            var apiKey = fourtwentycoins_1.fourtwentycoins.providers.PocketProvider.getApiKey({
                applicationId: 1234,
                applicationSecretKey: applicationSecretKey
            });
            console.log(apiKey);
        ...
        {
            var provider = new fourtwentycoins_1.fourtwentycoins.providers.PocketProvider("homestead", {
                applicationId: applicationId,
                applicationSecretKey: applicationSecretKey
            });
            assert_1.default.equal(provider.network.name, "homestead");
        ...
        // Attempt an unsupported network
        assert_1.default.throws(function () {
            var provider = new fourtwentycoins_1.fourtwentycoins.providers.PocketProvider("imaginary");
            console.log(provider);
        }, function (error) {
            return (error.argument === "network" && error.reason === "unsupported network");
        });
    ...
    it("InfuraProvider.getWebSocketProvider", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        provider = fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider.getWebSocketProvider();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.timeout(60000);
                        provider = new fourtwentycoins_1.fourtwentycoins.providers.InfuraProvider("rinkeby");
