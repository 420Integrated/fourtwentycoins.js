...
export class Opcode {
    ...
    constructor(mnemonic: string, value: number, delta: number, alpha: number, doc?: string) {
        fourtwentycoins.utils.defineReadOnly(this, "mnemonic", mnemonic);
        fourtwentycoins.utils.defineReadOnly(this, "value", value);
        fourtwentycoins.utils.defineReadOnly(this, "delta", delta);
        fourtwentycoins.utils.defineReadOnly(this, "alpha", alpha);
        fourtwentycoins.utils.defineReadOnly(this, "doc", doc || null);
    }
