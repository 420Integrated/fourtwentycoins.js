...
export class Node {
    constructor(guard, location, options) {
        ...
        for (const key in options) {
            fourtwentycoins.utils.defineReadOnly(this, key, options[key]);
        }
    }
    ...
    constructor(root, positionIndependentCode) {
        ...
        root.visit((node) => {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(("duplicate label: " + node.name), fourtwentycoins.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
        ...
        root.visit((node) => {
            ...
            if (node instanceof LinkNode) {
                ...
                if (!target) {
                    logger.throwError(("missing label: " + node.label), fourtwentycoins.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
            }
...
class CodeGenerationAssembler extends Assembler {
    ...
    assemble(label) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return logger.throwError(`unable to assemble; ${this.retry} attempts failed to generate stable bytecode`, fourtwentycoins.utils.Logger.errors.UNKNOWN_ERROR, {});
        });
    }
}
export function parse(code, options) {
    ...
    _parser.yy._fourtwentycoins Location = function (loc) {
