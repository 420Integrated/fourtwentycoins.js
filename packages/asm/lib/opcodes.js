...
var Opcode = /** @class */ (function () {
    function Opcode(mnemonic, value, delta, alpha, doc) {
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "mnemonic", mnemonic);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "value", value);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "delta", delta);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "alpha", alpha);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "doc", doc || null);
    }
...
var _Opcodes = {
    ...
    balance: { value: 0x31, delta: 1, alpha: 1, doc: "marley = balance(address)" },
    ...
    smokeprice: { value: 0x3a, delta: 0, alpha: 1, doc: "txSmokePrice = smokeprice" },
    ...
    smokelimit: { value: 0x45, delta: 0, alpha: 1, doc: "smoke = smokelimit" },
    ...
    smoke: { value: 0x5a, delta: 0, alpha: 1, doc: "remainingSmoke = smoke" },
    ...
    call: { value: 0xf1, delta: 7, alpha: 1, doc: "v = call(smokeLimit, address, value, inputIndex, inputLength, outputIndex, outputLength)", nonStatic: true, memory: "full" },
    ...
    delegatecall: { value: 0xf4, delta: 6, alpha: 1, doc: "v = delegatecall(smokeLimit, address, inputIndex, inputLength, outputIndex, outputLength)", nonStatic: true, memory: "full" },
    create2: { value: 0xf5, delta: 4, alpha: 1, doc: "address = create2(value, index, length, salt)", nonStatic: true, memory: "read" },
    staticcall: { value: 0xfa, delta: 6, alpha: 1, doc: "v = staticcall(smokeLimit, address, inputIndex, inputLength, outputIndex, outputLength)", memory: "full" },
