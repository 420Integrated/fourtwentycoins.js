...
function hexConcat(values) {
    return fourtwentycoins_1.fourtwentycoins.utils.hexlify(fourtwentycoins_1.fourtwentycoins.utils.concat(values.map(function (v) {
        if (v instanceof opcodes_1.Opcode) {
            return [v.value];
        }
        if (typeof (v) === "number") {
            if (v >= 0 && v <= 255 && !(v % 1)) {
                return fourtwentycoins_1.fourtwentycoins.utils.hexlify(v);
            }
            else {
...
var Script = /** @class */ (function () {
    function Script(filename, callback) {
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "filename", filename);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "contextObject", this._baseContext(callback));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "context", vm_1.default.createContext(this.contextObject));
    }
    Script.prototype._baseContext = function (callback) {
        ...
        return new Proxy({
            ...
            fourtwentycoins : fourtwentycoins_1.fourtwentycoins ,
            utils: fourtwentycoins_1.fourtwentycoins.utils,
            BigNumber: fourtwentycoins_1.fourtwentycoins.BigNumber,
            arrayify: fourtwentycoins_1.fourtwentycoins.utils.arrayify,
            concat: hexConcat,
            hexlify: fourtwentycoins_1.fourtwentycoins.utils.hexlify,
            zeroPad: function (value, length) {
                return fourtwentycoins_1.fourtwentycoins.utils.hexlify(fourtwentycoins_1.fourtwentycoins.utils.zeroPad(value, length));
            },
            id: fourtwentycoins_1.fourtwentycoins.utils.id,
            keccak256: fourtwentycoins_1.fourtwentycoins.utils.keccak256,
            namehash: fourtwentycoins_1.fourtwentycoins.utils.namehash,
            sha256: fourtwentycoins_1.fourtwentycoins.utils.sha256,
            parseFourtwentycoin: fourtwentycoins_1.fourtwentycoins.utils.parseFourtwentycoin,
            formatFourtwentycoin: fourtwentycoins_1.fourtwentycoins.utils.formatFourtwentycoin,
            parseUnits: fourtwentycoins_1.fourtwentycoins.utils.parseUnits,
            formatUnits: fourtwentycoins_1.fourtwentycoins.utils.formatUnits,
            randomBytes: function (length) {
                return fourtwentycoins_1.fourtwentycoins.utils.hexlify(fourtwentycoins_1.fourtwentycoins.utils.randomBytes(length));
            },
            toUtf8Bytes: fourtwentycoins_1.fourtwentycoins.utils.toUtf8Bytes,
            toUtf8String: fourtwentycoins_1.fourtwentycoins.utils.toUtf8String,
            formatBytes32String: fourtwentycoins_1.fourtwentycoins.utils.formatBytes32String,
            parseBytes32String: fourtwentycoins_1.fourtwentycoins.utils.parseBytes32String,
            Opcode: opcodes_1.Opcode,
            sighash: function (signature) {
                return fourtwentycoins_1.fourtwentycoins.utils.id(fourtwentycoins_1.fourtwentycoins.utils.FunctionFragment.from(signature).format()).substring(0, 10);
            },
            topichash: function (signature) {
                return fourtwentycoins_1.fourtwentycoins.utils.id(fourtwentycoins_1.fourtwentycoins.utils.EventFragment.from(signature).format());
            },
            assemble: assemble,
...
var Node = /** @class */ (function () {
    function Node(guard, location, options) {
        ...
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "location", Object.freeze(location));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "tag", "node-" + nextTag++ + "-" + this.constructor.name);
        for (var key in options) {
            fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, key, options[key]);
        }
    }
...
var ValueNode = /** @class */ (function (_super) {
    ...
    ValueNode.prototype.getPushLiteral = function (value) {
        ...
        var hex = fourtwentycoins_1.fourtwentycoins.utils.hexlify(value);
        if (hex === "0x") {
            throwError("invalid literal: 0x", this.location);
        }
        // Make sure it will fit into a push
        var length = fourtwentycoins_1.fourtwentycoins.utils.hexDataLength(hex);
            ...
            return __generator(this, function (_a) {
                ...
                if (this.verbatim) {
                    if (this.value.substring(0, 2) === "0x") {
                        ...
                        visit(this, fourtwentycoins_1.fourtwentycoins.BigNumber.from(this.value).toHexString());
                    }
                }
                else {
                    visit(this, this.getPushLiteral(fourtwentycoins_1.fourtwentycoins.BigNumber.from(this.value)));
                }
                assembler.end(this);
                return [2 /*return*/];
            });
                ...
                if (isOffset && assembler.positionIndependentCode) {
                    ...
                    if (here > value) {
                        ...
                        for (w = 1; w <= 5; w++) {
                            ...
                            if (fourtwentycoins_1.fourtwentycoins.utils.hexDataLength(literal) <= w) {
                                literal = fourtwentycoins_1.fourtwentycoins.utils.hexZeroPad(literal, w);
                                break;
                            }
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        // Append this opcode
                        visit(this, fourtwentycoins_1.fourtwentycoins.utils.hexlify(this.opcode.value));
                        assembler.end(this);
                        return [2 /*return*/];
                }
            });
...
var LabelledNode = /** @class */ (function (_super) {
    ...
    function LabelledNode(guard, location, name, values) {
        ...
        values = fourtwentycoins_1.fourtwentycoins.utils.shallowCopy(values || {});
        values.name = name;
...
var LabelNode = /** @class */ (function (_super) {
    ...
    LabelNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                assembler.start(this);
                visit(this, fourtwentycoins_1.fourtwentycoins.utils.hexlify(opcodes_1.Opcode.from("JUMPDEST").value));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
    ...
    PaddingNode.prototype.assemble = function (assembler, visit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                padding.fill(0);
                visit(this, fourtwentycoins_1.fourtwentycoins.utils.hexlify(padding));
                assembler.end(this);
                return [2 /*return*/];
            });
        });
...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(guard, location, name, data) {
        ...
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(_this, "padding", new PaddingNode(Guard, _this.location));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        bytecode = fourtwentycoins_1.fourtwentycoins.utils.concat(this.data.map(function (d) { return assembler.getBytecode(d); }));
                        i = 0;
                    ...
                    case 1:
                        ...
                        if (this.verbatim) {
                            if (typeof (result) === "number") {
                                visit(this, fourtwentycoins_1.fourtwentycoins.BigNumber.from(result).toHexString());
                            }
                            else {
                                visit(this, fourtwentycoins_1.fourtwentycoins.utils.hexlify(result));
                            }
                        }
                        else {
...
function disassemble(bytecode) {
    var ops = [];
    var offsets = {};
    var bytes = fourtwentycoins_1.fourtwentycoins.utils.arrayify(bytecode, { allowMissingPrefix: true });
    var i = 0;
    var oob = false;
    while (i < bytes.length) {
        var opcode = opcodes_1.Opcode.from(bytes[i]);
        if (!opcode) {
            opcode = new opcodes_1.Opcode("unknown (" + fourtwentycoins_1.fourtwentycoins.utils.hexlify(bytes[i]) + ")", bytes[i], 0, 0);
        }
        ...
        if (push) {
            var data = fourtwentycoins_1.fourtwentycoins.utils.hexlify(bytes.slice(i, i + push));
            if (fourtwentycoins_1.fourtwentycoins.utils.hexDataLength(data) === push) {
                op.pushValue = data;
                op.length += push;
                i += push;
            }
    ...
    ops.getBytes = function (offset, length) {
        ...
        return fourtwentycoins_1.fourtwentycoins.utils.arrayify(result);
    };
...
function formatBytecode(bytecode) {
    ...
    bytecode.forEach(function (op) {
        ...
        var offset = fourtwentycoins_1.fourtwentycoins.utils.hexZeroPad(fourtwentycoins_1.fourtwentycoins.utils.hexlify(op.offset), 2);
...
var Assembler = /** @class */ (function () {
    function Assembler(root, positionIndependentCode) {
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "root", root);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "positionIndependentCode", !!positionIndependentCode);
        var nodes = {};
        var labels = {};
        var parents = {};
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LabelledNode) {
                ...
                if (labels[node.name]) {
                    logger.throwError(("duplicate label: " + node.name), fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
        ...
        root.visit(function (node) {
            ...
            if (node instanceof LinkNode) {
                ...
                if (!target) {
                    logger.throwError(("missing label: " + node.label), fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.UNSUPPORTED_OPERATION, {});
                }
            }
        ...
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "labels", Object.freeze(labels));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "nodes", Object.freeze(nodes));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(this, "_parents", Object.freeze(parents));
    }
    // Link operations
    ...
    Assembler.prototype.getLinkValue = function (target, source) {
        ...
        var bytes = Array.prototype.slice.call(fourtwentycoins_1.fourtwentycoins.utils.arrayify(info.bytecode));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(bytes, "ast", target);
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(bytes, "source", target.location.source);
        ...
        if (!safeOffset) {
            ...
            fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(bytes, "_freeze", function () { });
        }
        ...
        if (safeOffset) {
            ...
            fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(bytes, "_freeze", function () {
                ...
                frozen_1 = true;
                fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(bytes, "offset", bytes.offset);
            });
        }
        return bytes;
    };
...
var CodeGenerationAssembler = /** @class */ (function (_super) {
    ...
    function CodeGenerationAssembler(root, options) {
        ...
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(_this, "retry", ((options.retry != null) ? options.retry : 512));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(_this, "filename", path_1.resolve(options.filename || "./contract.asm"));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(_this, "defines", Object.freeze(options.defines || {}));
        fourtwentycoins_1.fourtwentycoins.utils.defineReadOnly(_this, "_stack", []);
        _this.reset();
        return _this;
    }
        ...
        try {
            if (result.offset < 0) {
                ...
                this._checks.push(function () {
                    ...
                    if (check.offset === result.offset && fourtwentycoins_1.fourtwentycoins.utils.hexlify(check) === fourtwentycoins_1.fourtwentycoins.utils.hexlify(result)) {
                        return true;
                    }
                    return false;
                });
            ...
            this._checks.push(function () {
                var check = _super.prototype.getLinkValue.call(_this, target, source);
                return (fourtwentycoins_1.fourtwentycoins.utils.hexlify(check) === fourtwentycoins_1.fourtwentycoins.utils.hexlify(result));
            });
        }
        return result;
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.root.assemble(this, function (node, bytecode) {
                                ...
                                offset += fourtwentycoins_1.fourtwentycoins.utils.hexDataLength(bytecode);
                            })];
                    case 1:
                        _a.sent();
                        this._runChecks();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, logger.throwError("unable to assemble; " + this.retry + " attempts failed to generate stable bytecode", fourtwentycoins_1.fourtwentycoins.utils.Logger.errors.UNKNOWN_ERROR, {})];
                }
            });
        });
    };
...
function parse(code, options) {
    ...
    _parser_1.parser.yy._fourtwentycoins Location = function (loc) {
    ...
    _parser_1.parser.yy._fourtwentycoins Location = null;
    // Semantic Checks
