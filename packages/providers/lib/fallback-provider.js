...
var ForwardErrors = [
    ...
    logger_1.Logger.errors.UNPREDICTABLE_SMOKE_LIMIT
];
            ...
            switch (_b.label) {
                case 0:
                    ...
                    switch (_a) {
                        ...
                        case "getSmokePrice": return [3 /*break*/, 1];
                        case "getFourtwentycoinPrice": return [3 /*break*/, 2];
                        ...
                        case "estimateSmoke": return [3 /*break*/, 12];
                ...
                case 2:
                    if (provider.getFourtwentycoinPrice) {
                        return [2 /*return*/, provider.getFourtwentycoinPrice()];
                    }
                    return [3 /*break*/, 19];
                case 3:
