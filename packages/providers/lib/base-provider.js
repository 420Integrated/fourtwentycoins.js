...
var constants_1 = require("@420integrated/constants");
var hash_1 = require("@420integrated/hash");
var networks_1 = require("@420integrated/networks");
var properties_1 = require("@420integrated/properties");
var sha2_1 = require("@420integrated/sha2");
...
var BaseProvider = /** @class */ (function (_super) {
    ...
    BaseProvider.prototype.getSmokePrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.perform("getSmokePrice", {})];
    ...
    BaseProvider.prototype.estimateSmoke = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            var params, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        params = _c.sent();
                        _b = (_a = bignumber_1.BigNumber).from;
                        return [4 /*yield*/, this.perform("estimateSmoke", params)];
                    case 3: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                }
            });
        });
    ...
    BaseProvider.prototype.getFourtwentycoinPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getNetwork()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.perform("getFourtwentycoinPrice", {})];
                }
            });
        });
    };
