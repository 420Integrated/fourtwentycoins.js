...
var errorSmoke = ["call", "estimateSmoke"];
...
var JsonRpcSigner = /** @class */ (function (_super) {
    ...
    JsonRpcSigner.prototype.getAddress = function () {
        ...
        return this.provider.send("fourtwenty_accounts", []).then(function (accounts) {
    ...
    JsonRpcSigner.prototype.sendUncheckedTransaction = function (transaction) {
        ...
        return properties_1.resolveProperties({
            ...
            return _this.provider.send("fourtwenty_sendTransaction", [hexTx]).then(function (hash) {
                return hash;
            }, function (error) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        address = _a.sent();
                        return [4 /*yield*/, this.provider.send("fourtwenty_sign", [address.toLowerCase(), bytes_1.hexlify(data)])];
                    case 2: 
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        address = _a.sent();
                        return [4 /*yield*/, this.provider.send("fourtwenty_signTypedData_v4", [
                                address.toLowerCase(),
...
var JsonRpcProvider = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 9]);
                        return [4 /*yield*/, this.send("fourtwenty_chainId", [])];
                    case 3:
                        chainId = _a.sent();
                        return [3 /*break*/, 9];
                    case 4:
    ...
    JsonRpcProvider.prototype.listAccounts = function () {
        var _this = this;
        return this.send("fourtwenty_accounts", []).then(function (accounts) {
    ...
    JsonRpcProvider.prototype._startPending = function () {
        ...
        var self = this;
        var pendingFilter = this.send("fourtwenty_newPendingTransactionFilter", []);
