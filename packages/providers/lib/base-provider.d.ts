...
import { Block, BlockTag, BlockWithTransactions, EventType, Filter, FilterByBlockHash, Listener, Log, Provider, TransactionReceipt, TransactionRequest, TransactionResponse } from "@420integrated/abstract-provider";
...
export declare class BaseProvider extends Provider implements EnsProvider {
    ...
    getSmokePrice(): Promise<BigNumber>;
    ...
    estimateSmoke(transaction: Deferrable<TransactionRequest>): Promise<BigNumber>;
    ...
    getFourtwentycoinPrice(): Promise<number>;
