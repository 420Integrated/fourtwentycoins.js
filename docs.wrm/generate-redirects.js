...
<html>
  <head>
    <title>fourtwentycoins.js - Legacy Documentation</title>
    <style type="text/css">
      html {
...
const prefix = "fourtwentycoins.js/html/";
...
Object.keys(result).forEach((filename) => {
    ...
    const path = resolve(__dirname, "../docs/fourtwentycoins.js/html", filename);
