...
// Inject the crpyot shims (BEFORE the fourtwentycoins shims)
import "./crypto-shims.js";

// Inject the missing features with the fourtwentycoins shims
import "./libs/shims.js";

// Import fourtwentycoins 
import { fourtwentycoins } from "./libs/fourtwentycoins.js";
...
setTimeout(async function() {
    ...
    testing.setLogFunc(function(message) {
        ...
        inflight = inflight.then(() => {
            return fourtwentycoins.utils._fetchData("http:/\/localhost:8042/", fourtwentycoins.utils.toUtf8Bytes(message)).then((result) => {
                return true;
            }, (error) => {
                return false;
            });
