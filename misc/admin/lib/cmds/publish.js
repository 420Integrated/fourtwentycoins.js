...
const USER_AGENT = "fourtwentycoins-dist@0.0.1";
const TAG = "latest";
...
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (publishNames.indexOf("fourtwentycoins") >= 0 || forcePublish) {
            ...
            // Upload libs to the CDN (as fourtwentycoins-v5.0 and fourtwentycoins-5.0.x)
            {
                ...
                // Upload the libs to fourtwentycoins-v5.0 and fourtwentycoins-5.0.x
                const fileInfos = [
                    { filename: "packages/fourtwentycoins/dist/fourtwentycoins.esm.min.js", key: `fourtwentycoins-${change.version.substring(1)}.esm.min.js` },
                    { filename: "packages/fourtwentycoins/dist/fourtwentycoins.umd.min.js", key: `fourtwentycoins-${change.version.substring(1)}.umd.min.js` },
                    { filename: "packages/fourtwentycoins/dist/fourtwentycoins.esm.min.js", key: "fourtwentycoins-5.0.esm.min.js" },
                    { filename: "packages/fourtwentycoins/dist/fourtwentycoins.umd.min.js", key: "fourtwentycoins-5.0.umd.min.js" },
                ];
                for (let i = 0; i < fileInfos.length; i++) {
                    ...
                    console.log(`${log_1.colorify.bold("Uploaded:")} https://cdn.fourtwentycoins.io/lib/${key}`);
                }
            }
